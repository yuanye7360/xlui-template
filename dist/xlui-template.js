...
(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('async-validator'), require('vue')) :
  typeof define === 'function' && define.amd ? define(['exports', 'async-validator', 'vue'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['xlui-template'] = {}, global.AsyncValidator, global.Vue));
}(this, (function (exports, AsyncValidator, Vue) { 'use strict';
  ...
  var install = function (Vue, opts) {
    ...
    Object.keys(components).forEach(function (key) {
      Vue.component(key, components[key]); // Vue.use(components[key])
    });
